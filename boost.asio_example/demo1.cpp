...
void boost_asio_demo()
{
    ...
    for (int i = 0; i < 1000; i++) {
        ...
        if (rand() % 7 == 0) {
            t.async_wait(&print<0>);
        } else if ( i % 7 == 1) {
            t.async_wait(&print<1>);
        } else if ( i % 7 == 2) {
            t.async_wait(&print<2>);
        } else if ( i % 7 == 3) {
            t.async_wait(&print<3>);
        } else if ( i % 7 == 4) {
            t.async_wait(&print<4>);
        } else if ( i % 7 == 5) {
            t.async_wait(&print<5>);
        } else {
            t.async_wait(&print<6>);
        }
    }
